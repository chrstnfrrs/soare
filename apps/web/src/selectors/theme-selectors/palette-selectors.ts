...
type SelectPalette = (props: { theme: Theme, color?: string, contrastText?: string, border?: string }) => string
...
const selectPaletteContrast: SelectPalette = (props) => {
    ...
    return props.theme.colors.palette[props.color]?.contrastText ?? props.contrastText
}
